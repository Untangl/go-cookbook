...
property :go_server_url, [String, nil], required: false, default: nil
...
property :autoregister_environments, [String, Array, nil], required: false, default: nil
property :autoregister_resources, [String, Array, nil], required: false, default: nil
...
action :create do
  ...
  when 'java'
    ...
    if  (platform?('ubuntu') && node['platform_version'].to_f >= 16.04) || (platform?('amazon') && node['platform_version'].to_f >= 2)
